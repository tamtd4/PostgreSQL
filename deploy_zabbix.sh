...
cp -r ${SOURCE_DIR}/sql ${SCRIPT_DIR}/scripts/zapgix/
cp ${SOURCE_DIR}/zapgix.sh ${SCRIPT_DIR}/scripts/zapgix/
sudo chmod +x ${SCRIPT_DIR}/scripts/zapgix/zapgix.sh
cp ${SOURCE_DIR}/zabbix_agentd.conf ${ZABBIX_DIR}/zabbix_agentd.d/userparameter_postgresql.conf
